    ...
    <div class="wraper">
        ...
        <div id="container" class="grid wide" style="margin-top: 270px;">
            ...
            <div class="container_page_product">
                <a href="http://localhost/mvc-routing-Ver1.1/mvc-routing/index.php?controller=page&action=tv&page=1" class="page_product_direcational">1</a>
                <a href="http://localhost/mvc-routing-Ver1.1/mvc-routing/index.php?controller=page&action=tv&page=2" class="page_product_direcational" style="margin: 0 8px;">2</a>
            </div>
        </div>
        <!--footer-->
        <!-- <footer class="footer">
